...
s = Solver(states, use_mrv=True, use_lcv=True, use_forward_check=True)
s.solve()
...
s = Solver(secret_santa, use_mrv=True)
s.solve()
...
s = Solver(sudoku, use_mrv=True, use_lcv=True, use_forward_check=True)
s.solve()
